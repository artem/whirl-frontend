...
#define WHIRL_LOG_DEBUG(...) \
  WHIRL_LOG_IMPL(LogLevel::Debug, __VA_ARGS__)
#define WHIRL_LOG_INFO(...) WHIRL_LOG_IMPL(LogLevel::Info, __VA_ARGS__)
#define WHIRL_LOG_WARN(...) \
  WHIRL_LOG_IMPL(LogLevel::Warning, __VA_ARGS__)
#define WHIRL_LOG_ERROR(...) \
  WHIRL_LOG_IMPL(LogLevel::Error, __VA_ARGS__)
